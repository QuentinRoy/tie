 ...
 * may still be in the "unsettled" state when all of its parent has been re-evaluated without change
...
export default class Constraint {
    ...
    invalidate(){
        if(this._state === PROCESSED){
            ...
            throw "Cannot invalidate a constraint still being processed."
        }
     ...
     * be notified again.
     */
    _unsettle(alreadyNotified=new Set()){
