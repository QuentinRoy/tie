...
export default class Constraint {
     ...
     * @return true if the constraint value has changed, false otherwise.
     */
    _update(updateCallersDeps){
        ...
        if(this._state === invalid){
            ...
            // if the constraint value has changed, all dependent constraint
            // are invalidated.
            if(valueChanged){
                this._dependentConstraints.forEach((dc) => dc.invalidate());
            }
        }
        this._state = valid;
        return valueChanged;
